...
@WebServlet("/NewDonatorServelet")
public class NewDonatorServelet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Donator donator = new Donator(name,nic,address,gender,dob,bloodGroup,contactNo);
		dao.newDonator(donator);
